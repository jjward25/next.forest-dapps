                ...
                <div className={styles['project-top']} style={{borderBottom:'1px solid forestgreen',display:'flex'}}>
                    <div className={styles['project-top-left']} style={{width: '500px', display:'flex',flexDirection:'column', borderRight:'1px solid forestgreen', padding:'0 1.5% 1% 1.5%'}}>
                        ...
                        <div style={{display:'flex',borderBottom:'1px solid forestgreen',borderTop:'1px solid forestgreen', padding:'2.5% 0', justifyContent:'space-around'}}>
                           <img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt='Github' style={{height:'30px',width:'30px'}}></img>
                           <img src="https://cdn1.iconfinder.com/data/icons/social-media-circle-7/512/Circled_Medium_svg5-512.png" alt='Medium' style={{height:'30px',width:'30px'}}></img>
                           <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQnGvSDv_3Tjn7yYc5lE95CVqN9EUAI8t2jQ&usqp=CAU" alt='twitter' style={{height:'30px',width:'30px'}}></img>
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7iMIM-j3IgD4bpavEtFT2L8F1N-Koa-Lwag&usqp=CAU" alt='telegram' style={{height:'30px',width:'30px'}}></img>
                            <img src="https://logos-world.net/wp-content/uploads/2021/05/Logo-Discord.png" alt='discord' style={{height:'30px',width:'30px'}}></img>
                        </div>
